...
export const ProposalIcon = SatelliteAlt;
export const EditIcon = EditOutlined;
export const AddIcon = Add;
export const DownloadIcon = Download;
export const DownloadActiveIcon = Downloading;
  ...
  return (
    <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Box
        ...
        <Cancel sx={{ fontSize: '0.75em' }} />
      </Box>
    </Box>
  )
}

export const DeleteFlagIcon = <Fragment>{DeleteFlagIconMaker()}</Fragment>;

function RemoveFromCatalogIconMaker() {
  return (
    <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <AnalysisIcon sx={{ fontSize: '1.5em', zIndex: 0 }} />
      <Box
        sx={{
          position: 'relative',
          top: 7,
        ...
        <Cancel className="cancel-icon" sx={{ fontSize: '0.85em', background: 'white', borderRadius:"50%", zIndex:3 }} />
      </Box>
    </Box>
  )
}

export const RemoveFromCatalogIcon = <Fragment>{RemoveFromCatalogIconMaker()}</Fragment>;

function RemoveFromProposalIconMaker() {
  return (
    <Box sx={{
      position: 'relative',
      display: 'flex',
      ...
      <ProposalIcon className="proposal-icon" sx={{ fontSize: '1.75em', zIndex: 0 }} />
      <Box
...
export const RemoveFromProposalIcon = <Fragment>{RemoveFromProposalIconMaker()}</Fragment>;


// export const HomeIcon = Home
export const ListIcon = List
export const GridIcon = GridView
// Solar Bold Icons Collection 

// this is the cat icon at /public/jello.svg :)
